...
# ./python-virtualenv-pip.sh PYTHON_VER EASY_INSTALL_VER VIRTUALENV_VER
# 
#e.g. ./python-virtualenv-pip.sh 2.7.3 0.6.35 1.9.1 
...
if [[ $(easy_install-$PYTHON_VER_MAJOR --version) != distribute* ]]; then
    ...
    wget http://pypi.python.org/packages/source/d/distribute/distribute-$EASY_INSTALL_VER.tar.gz
